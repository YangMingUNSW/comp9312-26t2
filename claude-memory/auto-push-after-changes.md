...
description: Commit and push to GitHub after every code/file change in the COMP9312 repo
metadata:
  node_type: memory
  type: feedback
---

In the COMP9312 repo (and the user's similar personal repos), after every change to
...
distinct changes. See [[comp9312-repo]] and [[sync-memory-to-repo]].
