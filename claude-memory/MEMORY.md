...
- [COMP9312 repo](comp9312-repo.md) — private GitHub repo YangMingUNSW/comp9312-26t2, cross-platform store for all course assignments/projects.
- [Solution file convention](solution-file-convention.md) — every assignment ships a readable `_solution.md` plus a real `.tex` LaTeX source (named like the submission PDF) for Overleaf.
...
- [Assignment 2 solutions](assignment2-solutions.md) — 26T2 ass2 answers + conventions; question figures are inline SVG (decode them, don't text-scrape).
